...
Este programa sirve para descargar el código fuente de la versión más reciente del software profesional de animación OpenToonz, compilarlo e instalarlo de manera automática. 
